...
2. [自定义消息官方教程](https://micro.ros.org/docs/tutorials/advanced/create_new_type/)
3. [构建静态库官方教程](https://micro.ros.org/docs/tutorials/advanced/create_custom_static_library/)
