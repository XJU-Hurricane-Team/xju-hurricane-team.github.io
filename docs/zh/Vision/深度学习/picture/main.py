...
class YOLOv8:
    ...
    Examples:
        ...
        >>> output_image = detector.main() # doctest: +SKIP
    """
    ...
    def __init__(self, onnx_model: str, input_image: str, confidence_thres: float, iou_thres: float):
        ...
        self.classes = yaml_load(check_yaml("yolo-vbn.yaml"))["names"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img", type=str, default="/home/chairman/working/sum_result/result1/test_images/00014.jpg", help="Path to input image.")
